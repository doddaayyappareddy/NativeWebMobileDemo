    ...
    return (
        <>
            <View style={styles.multiButtonContainer}>
                <TouchableOpacity style={styles.back_button} onPress={() => navigation.navigate('MarketFluctuation')}>
                    <Text style={styles.back_button_text}>Back</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.next_button} onPress={() => navigation.navigate('InvestmentStyle')}>
